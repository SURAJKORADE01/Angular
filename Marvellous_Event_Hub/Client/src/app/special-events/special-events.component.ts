...
{  
  ...
  Register()
  {
    if(this.formValue.value.first == "" || this.formValue.value.first == null)
    {
      alert("Please enter your name.")
      return;
    }

    else if(this.formValue.value.last == "" || this.formValue.value.last == null)
    {
      alert("Please enter last name.")
      return;
    }

    else if(this.formValue.value.email == "" || this.formValue.value.email == null)
    {
      alert("Please enter your email address.")
      return;
    }

    else if(this.formValue.value.mobile == "" || this.formValue.value.mobile == null)
    {
      alert("Please enter your mobile number.")
      return;
    }

    else if(this.formValue.value.rid == "" || this.formValue.value.rid == null)
    {
